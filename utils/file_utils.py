...
output_path=Path(__file__).parents[1]/"allocation.csv" #this is the output file
...
#Did this here to avoid immediately reading the file when importing file_utils.py onto main.py.
#Wrapping it in a function allows us to call it in main.py when needed

def write_allocation(output_path,lines=None):
    '''This writes the results in the file.'''
